...
class Ensemble_cfcb_sbpr(object):
    ...
    def fit(self, URM, knn1, knn2, knn3, knn4, shrink, weights, use_cython=True, epochs=2, sgd_mode='rmsprop', lr=1e-4):
        self.URM = URM
    ...
    def recommend(self, target_playlist):
            ...
            row = ((self.weights[0]*row_R_CF_I) + (self.weights[1] * row_R_CF_U) + row_R_CB + (
