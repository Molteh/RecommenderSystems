...
class MatrixFactorization_Cython(Recommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300, batch_size = 1000, num_factors=10,
            learning_rate = 0.01, sgd_mode='sgd', user_reg = 0.0, positive_reg = 0.000, negative_reg = 0.0,
        ...
        from Progetto.recommenders.MF.MatrixFactorization_Cython_Epoch import MatrixFactorization_Cython_Epoch
    ...
    def runCompilationScript(self):
        ...
        compiledModuleSubfolder = "/MF/Cython"
